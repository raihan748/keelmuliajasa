  ...
  return (
    <section className="py-24 bg-white border-b-2 border-black" id="armada">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Fleet Cards Grid with Lateral Slide-Ins */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {fleetData.map((fleet, idx) => (
            <ScrollReveal key={idx} direction={fleet.direction} delay={idx * 0.12} className="h-full">
              <div className="h-full bg-slate-50 border-2 border-black rounded-3xl overflow-hidden shadow-neo hover:shadow-neo-xl hover:-translate-y-1.5 transition-all duration-200 flex flex-col justify-between group">
                <div>
                  {/* Photo Frame */}
        ...
        <ScrollReveal direction="diagonal-left" delay={0.15}>
              ...
              {commitments.map((com, cIdx) => {
                ...
                return (
                  <ScrollReveal key={cIdx} direction={com.dir} delay={cIdx * 0.1}>
                    <div className="h-full bg-white border-2 border-black rounded-2xl p-5 shadow-neo hover:shadow-neo-lg transition-all flex flex-col justify-between">
                      <div>
