    ...
    <section className="py-24 bg-neo-bg bg-neo-grid border-b-2 border-black relative overflow-hidden" id="klien-kami">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mb-14 bg-white border-2 border-black rounded-3xl p-6 sm:p-8 shadow-neo-xl"
        >
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6 pb-6 mb-6 border-b-2 border-black">
            ...
            <div className="inline-flex items-center gap-2 bg-slate-50 px-3.5 py-1.5 rounded-xl border-2 border-black shadow-neo-sm text-xs font-black text-slate-900">
          ...
          {clients.map((client, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white border-2 border-black rounded-3xl p-6 shadow-neo hover:shadow-neo-lg hover:-translate-y-1 transition-all duration-200 flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-12 h-12 rounded-2xl bg-slate-50 border-2 border-black text-slate-900 flex items-center justify-center shadow-neo-sm">
                  ...
                  <h4 className="text-lg font-black text-slate-900 mb-1 leading-snug">
                    {client.name}
                  </h4>
                  <div className="text-xs font-black text-amber-600 mb-3 uppercase tracking-wide">
                    {client.type}
                  </div>
                ...
                <div className="pt-3 border-t-2 border-black text-[11px] text-emerald-700 font-black flex items-center gap-1.5">
