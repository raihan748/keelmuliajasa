...
export const CtaBanner: React.FC = () => {
  return (
    <section className="py-24 bg-neo-bg text-white text-center relative overflow-hidden border-b-2 border-black">
      
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        <div className="bg-neo-surface border-2 border-black rounded-3xl p-8 sm:p-14 shadow-neo-xl relative">
          ...
          <p className="text-base sm:text-lg text-slate-300 font-medium leading-relaxed mb-9 max-w-2xl mx-auto">
            Hubungi tim operasional <strong className="text-neo-yellow font-black">CV. Keel Mulia Jasa</strong> sekarang juga untuk konsultasi gratis, cek estimasi tarif, dan pengiriman armada langsung ke lokasi Anda!
          </p>
