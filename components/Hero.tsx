...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative pt-10 pb-20 lg:pt-16 lg:pb-28 overflow-hidden bg-neo-bg bg-neo-grid border-b-2 border-black" id="hero">
      ...
      {/* Neo Glow Accents */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[350px] bg-neo-yellow/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              ...
              <span className="bg-neo-yellow text-black px-2.5 py-0.5 rounded-lg border-2 border-black shadow-neo inline-block rotate-[-1deg]">
                TPA Resmi
              </span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-slate-700 font-medium leading-relaxed max-w-2xl"
            >
            ...
            >
              <div className="flex items-center gap-2 bg-white p-2.5 rounded-xl border-2 border-black shadow-neo-sm text-xs font-black text-slate-900">
            ...
            >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                href="#armada"
                className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-white hover:bg-slate-50 text-slate-900 font-black text-base border-2 border-black shadow-neo hover:shadow-neo-lg transition-all"
              >
            ...
            <div className="grid grid-cols-3 gap-3 pt-4 border-t-2 border-black">
              <div className="bg-white p-3.5 rounded-2xl border-2 border-black shadow-neo-sm text-center">
                <div className="text-xl sm:text-2xl font-black text-amber-500 font-mono">
                  <AnimatedCounter to={5000} suffix="+" />
                </div>
                <div className="text-[10px] sm:text-xs font-black text-slate-700">Ritase Terangkut</div>
              </div>
              <div className="bg-white p-3.5 rounded-2xl border-2 border-black shadow-neo-sm text-center">
                <div className="text-xl sm:text-2xl font-black text-emerald-600 font-mono">
                  <AnimatedCounter to={100} suffix="%" />
                </div>
                <div className="text-[10px] sm:text-xs font-black text-slate-700">TPA Berizin Resmi</div>
              </div>
              <div className="bg-white p-3.5 rounded-2xl border-2 border-black shadow-neo-sm text-center">
                <div className="text-xl sm:text-2xl font-black text-blue-600 font-mono">
                  <AnimatedCounter to={24} suffix="/7" />
                </div>
                <div className="text-[10px] sm:text-xs font-black text-slate-700">Siaga Pelayanan</div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5">
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
              className="bg-white border-2 border-black rounded-3xl p-6 sm:p-8 shadow-neo-xl relative"
            >
              {/* Card Header */}
              <div className="flex items-center justify-between pb-4 mb-5 border-b-2 border-black">
                <div className="flex items-center gap-2.5">
                  <div className="bg-slate-50 p-2 rounded-xl border-2 border-black shadow-neo-sm">
                    <img
                  ...
                  <div>
                    <h3 className="font-black text-slate-900 text-base">Konsultasi & Estimasi Cepat</h3>
                    <p className="text-[11px] text-amber-600 font-black">Respon Cepat Tim Operasional</p>
                  </div>
                </div>
              ...
              <form onSubmit={handleQuickSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-black text-slate-800 mb-1.5 uppercase tracking-wide">
                    Jenis Sampah / Muatan
                  </label>
                  <select
                    value={wasteType}
                    onChange={(e) => setWasteType(e.target.value)}
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border-2 border-black text-slate-900 text-xs sm:text-sm font-semibold focus:outline-none focus:border-neo-yellow focus:shadow-neo-sm transition-all"
                  >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3.5 py-2.5 rounded-xl bg-slate-50 border-2 border-black text-slate-900 placeholder-slate-400 text-xs sm:text-sm font-semibold focus:outline-none focus:border-neo-yellow focus:shadow-neo-sm transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="pt-1">
                  <div className="text-[11px] font-black text-slate-600 uppercase mb-2">Armada Siaga Hari Ini:</div>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-slate-50 p-2 rounded-xl border-2 border-black shadow-neo-sm flex items-center gap-2">
                      <img
                      ...
                      />
                      <div>
                        <div className="text-[11px] font-black text-slate-900">Dump Truck</div>
                        <div className="text-[9px] text-amber-600 font-bold">Puing & Proyek</div>
                      </div>
                    </div>
                    ...
                    <div className="bg-slate-50 p-2 rounded-xl border-2 border-black shadow-neo-sm flex items-center gap-2">
                      ...
                      />
                      <div>
                        <div className="text-[11px] font-black text-slate-900">Pick Up L300</div>
                        <div className="text-[9px] text-emerald-600 font-bold">Residensial</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-14 flex justify-center">
          <a
            href="#tentang-kami"
            className="inline-flex flex-col items-center gap-2 text-xs font-black text-slate-600 hover:text-black transition-colors group cursor-pointer"
          >
            <span>Scroll untuk Eksplor Profil & Bukti Lapangan</span>
            <div className="w-8 h-8 rounded-xl bg-white border-2 border-black shadow-neo-sm flex items-center justify-center group-hover:bg-neo-yellow group-hover:shadow-neo transition-all animate-bounce">
